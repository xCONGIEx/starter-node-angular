...
function updateRemoteApp() {
  return ssh.execCommand(
    'mkdir starter-node-angular && cp -r starter-node-angulart-temp/* starter-node-angular/ && rm -rf starter-node-angular-temp', {
      cwd: '/home/ubuntu'
  });
}
...
function sshConnect() {
  ...
  ssh
    .connect({
      ...
      host: '34.227.173.145',
      username: 'ubuntu',
      privateKey: 'Deployment-FinalProject-KeyPair.pem'
    })
    .then(function() {
